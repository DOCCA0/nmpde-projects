...
\begin{equation}
 ...
 \label{eq:mu}
\end{equation}
We look for $u:\overline\Omega\rightarrow\mathbb{R}$ satisfying
\begin{equation}
...
\begin{equation}
    ...
    \ge \frac{1}{1+C_P^2}\|v\|_{H^1(\Omega)}^2.
\end{equation}
...
From the suitable discrete space:
\begin{equation}
 V_h=\{v_h\in C^0(\overline\Omega):v_h|_K\in P_1(K),\ v_h|_{\partial\Omega}=0\}.
\end{equation}
...
\begin{equation}
 \|\boldsymbol r_k\|\le10^{-10}\|\boldsymbol b\|,
